...
public class Experiment
{
	...
	public void runExperiment() {
		writer.println("Experiment Number, Number of Perturbations, Rubik's Cube, Move Applied");
		for(int j=1; j<=3; j++) {
			for(int k=1; k<=5; k++) {
	...
	private void writeResults(ArrayList<Searchable> cubes, ArrayList<Move> moves, int perturbations) {
