...
class GenomeExt
{
	...
	public double getProbSelFR() {
		return probSelFR;
	}
	public void setProbSelFR(double probSelFR) {
		this.probSelFR = probSelFR;
	}
	...
	public double getProbSelCR() {
		return probSelCR;
	}
	public void setProbSelCR(double probSelCR) {
		this.probSelCR = probSelCR;
	}
}
