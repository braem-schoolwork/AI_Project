...
public class IllegalGAParamsException extends RuntimeException
{
	...
	public IllegalGAParamsException()									{ super(); }
	public IllegalGAParamsException(String message) 					{ super(message); }
	public IllegalGAParamsException(String message, Throwable cause) 	{ super(message, cause); }
	public IllegalGAParamsException(Throwable cause) 					{ super(cause); }
}
