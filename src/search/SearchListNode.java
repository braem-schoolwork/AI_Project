...
public class SearchListNode implements Comparable<SearchListNode>
{
	...
	public float 			f() 				{ return gVal + searchableObj.h(); }

	@Override
	public int compareTo(SearchListNode sln) {
		if(this.f() > sln.f())			return 10;
		else if(this.f() < sln.f())		return -10;
		else							return 0;
	}
	
	@Override
	public boolean equals(Object obj) {
		if(!(obj instanceof SearchListNode))
			return false;
		return this.searchableObj.equals(((SearchListNode)obj).getSearchableObj());
	}
	
	@Override
	public int hashCode() 	{ return searchableObj.hashCode(); }
}
